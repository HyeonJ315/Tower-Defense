...
namespace Assets.Scripts.TurretScripts.TurretData
{
    class TurretDictionary
    {
        ...
        private static readonly TurretDictionary I = new TurretDictionary();
        static TurretDictionary() { }
        private TurretDictionary() { }
        public static TurretDictionary Instance { get { return I; } }
