...
{
    internal class MobDictionary
    {
        #region Singleton

        private static readonly MobDictionary I = new MobDictionary();
        static MobDictionary(){} private MobDictionary(){}
        public static MobDictionary Instance { get { return I; } }
